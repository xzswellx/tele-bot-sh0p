...
bot.on('message', (msg) => {
    ...
    switch (text) {
        ...
        case 'Корзина 🛒':
            ...
            break;
        case 'Поддержка 🛠️':
            bot.sendMessage(chatId, 'Если у вас возникили какие-то вопросы, пишите нашему администратору - @swag_admin, постараемся ответить быстро!');
            break;
